    ...
    <div className="main-dashboard">
      ...
      <div className="dashboard-qr-container">
        <div className="qr-text-left">
          ...
          <h2 className="text-2xl">{selectedVenue?"Your digital menu is ready!":'To Continue Create Venue'}</h2>

          <h4>{selectedVenue?"Scan the QR code or use the link to view your brand new menu.":"Get your QR code by creating new venue"}</h4>
